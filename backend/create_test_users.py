"""
سكريبت لإنشاء مستخدمين للاختبار
استخدام: python create_test_users.py
"""
...
# إعداد Django
# السكريبت موجود في backend/create_test_users.py
# school_backend موجود في backend/school_backend/
